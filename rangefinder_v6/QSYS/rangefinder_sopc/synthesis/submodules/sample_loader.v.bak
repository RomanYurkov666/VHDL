...
always@ (posedge avs_clk)
        begin
          if (avs_reset)
			 ...
			 4: begin avs_readdata<={1'b0,pulse_abs_coord2[12:0],sample_size2[7:0],buffer_full2,stop_detected2,ram_ptr2[7:0]}; end 
			 4: begin avs_readdata<={1'b0,pulse_abs_coord3[12:0],sample_size3[7:0],buffer_full3,stop_detected3,ram_ptr3[7:0]}; end 
			 4: begin avs_readdata<={1'b0,pulse_abs_coord4[12:0],sample_size4[7:0],buffer_full4,stop_detected4,ram_ptr4[7:0]}; end 
			 4: begin avs_readdata<={1'b0,pulse_abs_coord5[12:0],sample_size5[7:0],buffer_full5,stop_detected5,ram_ptr5[7:0]}; end 
			 default: begin end 
			 endcase 
			 end
        end 		
