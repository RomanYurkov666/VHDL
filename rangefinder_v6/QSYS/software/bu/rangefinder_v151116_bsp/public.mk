...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../rangefinder_sopc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is rangefinder_sopc
SOPC_NAME := rangefinder_sopc
...
# The SOPC System ID 
# setting SOPC_SYSID is 320043385
SOPC_SYSID_FLAG += --id=320043385
ELF_PATCH_FLAG  += --id 320043385

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x9860
SOPC_SYSID_FLAG += --sidp=0x9860
ELF_PATCH_FLAG  += --sidp 0x9860

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1479201407
SOPC_SYSID_FLAG += --timestamp=1479201407
ELF_PATCH_FLAG  += --timestamp 1479201407
...
# setting hal.stderr is pc_uart
ELF_PATCH_FLAG  += --stderr_dev pc_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is pc_uart
ELF_PATCH_FLAG  += --stdin_dev pc_uart
...
# setting hal.stdout is pc_uart
ELF_PATCH_FLAG  += --stdout_dev pc_uart
