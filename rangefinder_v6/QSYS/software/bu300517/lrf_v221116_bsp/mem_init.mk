...
# Memory: ram_cpu
MEM_0 := rangefinder_sopc_ram_cpu
$(MEM_0)_NAME := ram_cpu
...
$(MEM_0)_HIERARCHICAL_PATH := ram_cpu
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: ram_cpu
ram_cpu: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: ram_sample_0
MEM_1 := rangefinder_sopc_ram_sample_0
$(MEM_1)_NAME := ram_sample_0
...
$(MEM_1)_START := 0x00009500
$(MEM_1)_END := 0x000095ff
$(MEM_1)_SPAN := 0x00000100
$(MEM_1)_HIERARCHICAL_PATH := ram_sample_0
$(MEM_1)_WIDTH := 8
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: ram_sample_0
ram_sample_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: ram_sample_1
MEM_2 := rangefinder_sopc_ram_sample_1
$(MEM_2)_NAME := ram_sample_1
...
$(MEM_2)_START := 0x00009400
$(MEM_2)_END := 0x000094ff
$(MEM_2)_SPAN := 0x00000100
$(MEM_2)_HIERARCHICAL_PATH := ram_sample_1
$(MEM_2)_WIDTH := 8
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: ram_sample_1
ram_sample_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: ram_sample_2
MEM_3 := rangefinder_sopc_ram_sample_2
$(MEM_3)_NAME := ram_sample_2
...
$(MEM_3)_START := 0x00009300
$(MEM_3)_END := 0x000093ff
$(MEM_3)_SPAN := 0x00000100
$(MEM_3)_HIERARCHICAL_PATH := ram_sample_2
$(MEM_3)_WIDTH := 8
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: ram_sample_2
ram_sample_2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: ram_sample_3
MEM_4 := rangefinder_sopc_ram_sample_3
$(MEM_4)_NAME := ram_sample_3
...
$(MEM_4)_START := 0x00009200
$(MEM_4)_END := 0x000092ff
$(MEM_4)_SPAN := 0x00000100
$(MEM_4)_HIERARCHICAL_PATH := ram_sample_3
$(MEM_4)_WIDTH := 8
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0

.PHONY: ram_sample_3
ram_sample_3: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym

# Memory: ram_sample_4
MEM_5 := rangefinder_sopc_ram_sample_4
$(MEM_5)_NAME := ram_sample_4
...
$(MEM_5)_START := 0x00009100
$(MEM_5)_END := 0x000091ff
$(MEM_5)_SPAN := 0x00000100
$(MEM_5)_HIERARCHICAL_PATH := ram_sample_4
$(MEM_5)_WIDTH := 8
$(MEM_5)_ENDIANNESS := --little-endian-mem
$(MEM_5)_CREATE_LANES := 0

.PHONY: ram_sample_4
ram_sample_4: check_elf_exists $(MEM_INIT_DIR)/$(MEM_5).hex $(HDL_SIM_DIR)/$(MEM_5).dat $(HDL_SIM_DIR)/$(MEM_5).sym

# Memory: ram_sample_5
MEM_6 := rangefinder_sopc_ram_sample_5
$(MEM_6)_NAME := ram_sample_5
...
$(MEM_6)_START := 0x00009000
$(MEM_6)_END := 0x000090ff
$(MEM_6)_SPAN := 0x00000100
$(MEM_6)_HIERARCHICAL_PATH := ram_sample_5
$(MEM_6)_WIDTH := 8
$(MEM_6)_ENDIANNESS := --little-endian-mem
$(MEM_6)_CREATE_LANES := 0

.PHONY: ram_sample_5
ram_sample_5: check_elf_exists $(MEM_INIT_DIR)/$(MEM_6).hex $(HDL_SIM_DIR)/$(MEM_6).dat $(HDL_SIM_DIR)/$(MEM_6).sym
