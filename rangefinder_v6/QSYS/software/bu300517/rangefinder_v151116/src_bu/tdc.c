...
#define TDC7200_ENABLE IOWR_ALTERA_AVALON_PIO_DATA(TDC_ENABLE_BASE,0x1)
#define TDC7200_DISABLE IOWR_ALTERA_AVALON_PIO_DATA(TDC_ENABLE_BASE,0x0)

unsigned char TDC7200_reg_local_copy[10] = {0x02, 0x44, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0x0, 0x0};//{0x02, 0x44, 0x07, 0x07, 0xFF, 0xFF, 0xFF, 0xFF, 0x0, 0x0};
...
void Init_TDC7200(void)
{
	//UCB1CTLW0 &= ~UCSWRST;	// Switch on SPI module - ‚ÒÂ„‰‡ ‚ÍÎ˛˜ÂÌ
