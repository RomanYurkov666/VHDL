...
#define SDA_READ_MODE     IOWR_ALTERA_AVALON_PIO_DIRECTION(I2C_PORT_BASE, BIT0|(~BIT1))
...
void i2c_send_bit(unsigned char send_bit)
{
	SDA_WRITE_MODE;   //TRISBbits.TRISB5=0; //output
...
{
    //TRISBbits.TRISB4=0;
	SDA_WRITE_MODE;  //TRISBbits.TRISB5=0; //outputs
